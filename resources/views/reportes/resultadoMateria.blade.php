...
<div class="container">
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-4" style="text-align:right;padding-right:35px"> 
                    <a href="{{route('reportes.MateriaCarreraPeriodo')}}" class="btn btn-primary"><svg width="4em" height="2em" viewBox="0 0 16 16" class="bi bi-arrow-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M2.5 8a.5.5 0 0 1 .5-.5h10.5a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/></svg></a>
        ...
        <br>
        <?php $i=$_GET["select2"]-1 ?>
        <h2>{{$periodos[$i]->PER_NOMBRE}} </h2>    
                </div>
        ...
        <?php $i=0 ?> 
            @foreach($materias as $materia)
                ...
                <tr>
                    ...
                    <td>{{$materia->DOC_NOMBRES}} {{$materia->DOC_APELLIDOS}}</td>
                </tr>
            @endforeach
