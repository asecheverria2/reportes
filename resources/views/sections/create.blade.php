...
<div class="container">
    <div class="card">
        ...
        <ul>
            ...
            @endforeach
        </ul @endif <form action="{{route('sections.store')}}" method="POST" novalidate>
        @csrf
            ...
            <label for="detalle">Detalle</label>
                        <textarea class="form-control" name="detalle" id="detalle" cols="30" rows="10">{{old('detalle')}}</textarea>
