...
<div class="container">
    <div class="card">
        ...
        <ul>
            ...
            @endforeach
        </ul @endif <form action="{{route('materias.store')}}" method="POST" novalidate>
        @csrf
                        
                                        <div class="form-group">
            <label for="mat_nombre">Mat Nombre</label>
                        <input class="form-control String"  type="text"  name="mat_nombre" id="mat_nombre" value="{{old('mat_nombre')}}"             maxlength="50"
                                    required="required"
                        >
            ...
            <label for="mat_docente">Mat Docente</label>
                        <input class="form-control String"  type="text"  name="mat_docente" id="mat_docente" value="{{old('mat_docente')}}"             maxlength="50"
                                    required="required"
                        >
            ...
            <label for="mat_nrc">Mat Nrc</label>
                        <input class="form-control Integer"  type="number"  name="mat_nrc" id="mat_nrc" value="{{old('mat_nrc')}}"                         required="required"
                        >
            ...
            <label for="mat_horas">Mat Horas</label>
                        <input class="form-control Integer"  type="number"  name="mat_horas" id="mat_horas" value="{{old('mat_horas')}}"                         required="required"
                        >
